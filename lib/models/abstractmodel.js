...
AbstractModel.prototype.table = "Please set your model's prototype.table to use batabase functionality";
...
AbstractModel._initHasMany = function() {
  this._hasMany.forEach(function(def) {
    ...
    this.prototype[name] = function(options, callback) {
...
AbstractModel.prototype.insert = function(callback) {
  ...
  this.fields.forEach(function(field) {
    ...
    var value = 'null' === this[field] ? null : functions.XSS(this[field].toString());
    values.push(escape("%L", value));
  });
...
AbstractModel.prototype.update = function(callback) {
  ...
  var fields = [];
  this.fields.forEach(function(field) {
    if (this.fields[i] == 'id' || 'undefined' == typeof this[this.fields[i]]) {
      return;
    }
    fields.push(escape("%I = %L", this.fields[i], this[this.fields[i]]));
  });
